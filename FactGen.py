...
if Path('./my/custom/factListModule.py').exists():
    from my.custom.factListModule import factlist
else:
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        QFontDatabase.addApplicationFont("fonts/NimbusSansNarrowRegular.ttf")
        ...
        QFontDatabase.addApplicationFont("fonts/TlwgTypistBold.ttf")        
        ...
        self.gif = QMovie("images/space.gif")
